...
public class BlockRegistry {
	...
	public static HashMap<String, BlockEntry<ConnectedGlassPaneBlock>> WINDOW_PANES = new HashMap<>();
	...
	public static void init() {
		...
		ItemRegistry.METAL_TYPES.forEach(BlockRegistry::registerWindowPanes);
	...
	private static void registerWindows(String metal, Function<String, Item> getter) {
		WINDOWS.put(metal, Windows.metalWindowBlock(metal));
	}

	private static void registerWindowPanes(String metal, Function<String, Item> getter) {
		WINDOW_PANES.put(metal, Windows.metalWindowPane(metal, WINDOWS.get(metal)));
	}
