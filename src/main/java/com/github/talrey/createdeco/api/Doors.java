...
public class Doors {
    ...
    public static NonNullBiConsumer<DataGenContext<Block, DecoDoorBlock>, RegistrateRecipeProvider> recipe(
            Supplier<Item> ingot
    ) {
    ...
    public static BlockBuilder<DecoDoorBlock, CreateRegistrate> build(
        ...
        return reg.block(regName, p -> DecoDoorBlock.factory(locked ? BlockSetType.GOLD : OPEN_METAL_DOOR, p))
    ...
    public static NonNullBiConsumer<DataGenContext<Block, DecoDoorBlock>, RegistrateRecipeProvider> lockedRecipe(
    ...
    public static BlockBuilder<DecoTrapDoorBlock, ?> buildTrapdoor(
        ...
        return reg.block(regName, p -> DecoTrapDoorBlock.factory(p, OPEN_METAL_DOOR))
    ...
    public static NonNullBiConsumer<DataGenContext<Block, DecoTrapDoorBlock>, RegistrateRecipeProvider> trapdoorRecipe(
            Supplier<Item> ingot
    ) {
